...
//		 * Log in using our custom methods Go to
//		 * PIM menu Add an employee 
//		 * Go to Employee List Get the list of the employees
//		 * (Using tables - tr and td) 
...
//		 */
		...
		sendText(driver.findElement(By.id("first-name-box")), "Ligia");
		sendText(driver.findElement(By.id("last-name-box")), "Moya");
		...
		while (!found) {
			...
			// If I have not found the employee yet, it is probably because its not on this
			// page
